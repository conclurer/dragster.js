...
test('drake can be instantiated without throwing', t => {
    t.doesNotThrow(() => mockDragula(), 'calling dragula() without arguments does not throw');
    t.end();
});

test('drake has expected api properties', t => {
